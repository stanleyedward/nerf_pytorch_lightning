...
class Voxels(nn.Module):
    ...
    def forward(self, xyz):
        ...
        idx_x = (x[condition] / (self.scale / self.nb_voxels) + self.nb_voxels / 2).type(torch.long) 
        idx_y = (y[condition] / (self.scale / self.nb_voxels) + self.nb_voxels / 2).type(torch.long) 
        idx_z = (z[condition] / (self.scale / self.nb_voxels) + self.nb_voxels / 2).type(torch.long) 
